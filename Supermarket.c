...
int		initSuperMarket(SuperMarket* pMarket, const char* fileName,const char* customersFileName,int isCompress)
{
	if (isCompress == 1) {
		loadSuperMarketFromCompressFile(pMarket, fileName, customersFileName);
		return 1;
	}
	...
	{
		if (loadSuperMarketFromCompressFile(pMarket, fileName, customersFileName))
		{
